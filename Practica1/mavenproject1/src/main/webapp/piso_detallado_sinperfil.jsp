...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="piso_detallado_sinperfil.css?4.0"  type="text/css" media="all">
        <!-- API MAPA -->
            ...
            <li>
                <div class = "cuerpoDatos">
                    <div class="cabecera_1">
                        <a href="index.html"><img src="img/IMG_0118.png" class="lobby" alt="lobby image"></a>
                        <div class="opciones">
                            <a href="registro.jsp"><input type="submit" value="Registrarse"></a>
                            <a href="sesion.jsp"><input type="submit" value="Iniciar Sesión"></a>
                        </div>
                    </div>
                    <div class = datos>
                        <div class="col_1">
                    ...
                    <div class ="varios">
                        ...
                        <button type=varios_btn>Compartir</button>
                        <form action="alquilarPisoServlet" method="post">
                            <p>¿Hasta cuando quieres reservar? </p>
                            <input type="text" id="datepicker" name="fecha">
                            <input type="submit" class="varios_btn" value="Reservar piso">
                            <input type="hidden" name="idUser" value="0">
                            <input type="hidden" name="idPiso" value="<%=pisoDet.getId_Piso()%>">
