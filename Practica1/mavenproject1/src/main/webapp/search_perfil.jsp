...
<html lang="es">
    <head>
       <meta charset="utf-8">
       <link rel="stylesheet" href="search_perfil.css?4.0" type="text/css" media="all">
...
<%
        ...
        <div class="container">
            <nav class="navMain">
                <a href="indexPerfil.jsp"><img src="img/IMG_0118.png" alt="LOGO" class="brand"></a>
                ...
                <ul class="navMenuR">
                    <a href="modificar_perfil.jsp"><img  class=avatar src="img/png-transparent-computer-icons-user-user-icon.png"></a>
                    <div class="dropdown">
                ...
                <div id="filters" class="filters">
                    ...
                    <form action="filtroServlet" method="post">
                        ...
                        <li>
                         ...
                         <input type="submit" value="Buscar" class="botonNaranja">
